...
export class updateSale
{
    ...
    updateSaleMaster(SaleMaster = {})
    {
        ...
        let updateQry = this.current.generateUpdateQuery([SaleMaster],["SaleId","CreatedDate"],["SaleId","DocNo"],
        "","t_sale_master")
    ...
    updateSaleDetail(SaleId=-1,DocNo)
    {
        let deleteQry = 'Delete from t_sale_detail where DocNo='+DocNo+'  and SaleId = '+SaleId
