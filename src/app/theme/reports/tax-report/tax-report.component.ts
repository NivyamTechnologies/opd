...
export class TaxReportComponent implements OnInit {
  ...
  getReport()
  {
    this.api.Post("/total/getBrowser",{Condition : ""},["EntityName=odpreport","Type=Report","Dropdown=DateRange","From="+this.from,"To="+this.to]).subscribe(data=>{
  ...
  exportToExcel()
  {
      this.api.exportToExcel(this.dataRows,"OPDREPORT")
  }
}
