...
export class StockreportComponent implements OnInit {
  ...
  getReport()
  {
    this.api.Post("/total/getBrowser",{Condition : ""},["EntityName=idpreport","Type=Report","Dropdown=DateRange","From="+this.from,"To="+this.to]).subscribe(data=>{
  ...
  exportToExcel()
  {
      this.api.exportToExcel(this.dataRows,"IPDREPORT")
  }
}
